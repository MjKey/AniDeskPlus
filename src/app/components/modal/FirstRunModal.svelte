...
{#if showed}
    ...
    <div class="modal-content">
        <p>
            Добро пожаловать! Вы используете <strong>AniXFlow</strong> — неофициальный форк десктоп-клиента AniDesk для Anixart, созданный для более удобного просмотра контента с Anixart на ПК. Мы не связаны с оригинальными разработчиками Anixart.
        </p>
        <p>
